...
namespace BlockWorks.Server
{
	...
	{
		public static uint ToBlocks(uint x, uint y, uint layer = 0) => ((layer & 3) << 30) | ((x & 32767) << 15) | (y & 32767);

		public static uint GetX(uint blockdata) => (blockdata >> 15) & 32767;

		public static uint GetY(uint blockdata) => blockdata & 32767;

		public static uint GetLayer(uint blockdata) => (blockdata >> 30) & 3;
